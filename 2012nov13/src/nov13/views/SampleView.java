...
public class SampleView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		final IOConsole console = new IOConsole("NAME", null);
		final IOConsoleOutputStream out = console.newOutputStream();
		final IOConsoleInputStream in = console.getInputStream();
		final IOConsoleViewer viewer2 = new IOConsoleViewer(parent, console);
		final DebuggerMagic magic = new DebuggerMagic();
